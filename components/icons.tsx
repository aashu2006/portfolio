/**
 * Inline SVG marks, rather than an icon package. A handful of glyphs does not
 * justify a dependency, and drawing them here means they inherit
 * `currentColor` and follow the theme with no colour rules of their own.
 *
 * All of them are `aria-hidden`: every one is wrapped in a link that already
 * carries its own label, so announcing the glyph too would just repeat it.
 */
...
/** Live-site link on a project card. */
